  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.quickActions}>
        <div className={classes.quickCard} onClick={() => !isLoading && explainFormula()}>
